...
const
  ...
  FLAC_BLOCK_TYPE_STRINGS: array[0..6] of String = (
...
type
  ...
  PMetaDataBlockHeader = ^TMetaDataBlockHeader;
  TMetaDataBlockHeader = record
  ...
  PStreamInfoBlock = ^TStreamInfoBlock;
  ...
  TPaddingBlock = record
    { <n> 0 bytes }
  end;

  TSeekTableBlock = record
  ...
  PSubframeHeader = ^TSubframeHeader;
  TSubframeHeader = record
  ...
  PSampleBuffer = ^TSampleBuffer;  { We need this to pass the 2nd dimension of channelBuffers by reference }
  TSampleBuffer = array of LongInt;
...
function FLAC2PCM(flac: TStream; pcm: TStream; var streamInfoBlock: TStreamInfoBlock): LongWord;

{ Read Headers }
function FLACReadMetaDataBlockHeader(flac: TStream; metaDataBlockHeader: PMetaDataBlockHeader): DWord;
function FLACReadStreamInfoBlock(flac: TStream; streamInfoBlock: PStreamInfoBlock): DWord;
function FLACReadFrameHeader(flac: TStream; frameHeader: PFrameHeader): DWord;
function FLACReadSubframeHeader(bitReader: TBitReader; subframeHeader: PSubframeHeader): DWord;

{ Read Subframe }
function FLACReadSubframeConstant(frameHeader: PFrameHeader; subframeHeader: PSubframeHeader; bitReader: TBitReader; sampleHandle: PSampleBuffer): DWord;
function FLACReadSubframeVerbatim(frameHeader: PFrameHeader; subframeHeader: PSubframeHeader; bitReader: TBitReader; sampleHandle: PSampleBuffer): DWord;
function FLACReadSubframeFixed(frameHeader: PFrameHeader; subframeHeader: PSubframeHeader; bitReader: TBitReader; sampleHandle: PSampleBuffer): DWord;
function FLACReadSubframeLPC(frameHeader: PFrameHeader; subframeHeader: PSubframeHeader; bitReader: TBitReader; sampleHandle: PSampleBuffer): DWord;
function FLACReadLPCResidual(frameHeader: PFrameHeader; subframeHeader: PSubframeHeader; bitReader: TBitReader; sampleBuffer: TSampleBuffer; sampleIndex: Integer; coefficients: array of SmallInt; qlpShift: Integer): DWord;
...
{ Logging functions }
procedure LogMetaDataBlockHeader(metaDataBlockHeader: PMetaDataBlockHeader);
procedure LogStreamInfoBlock(streamInfoBlock: PStreamInfoBlock);
procedure LogFrameHeader(frameHeader: PFrameHeader);
procedure LogSubframeHeader(subframeHeader: PSubframeHeader);
...
var
  ...
  subframeHeader: TSubframeHeader;
  channel: Integer;
  bitReader: TBitReader;
  channelBuffers: array of TSampleBuffer;
  sampleIndex: Integer;
...
begin
  ...
  flac.Read(streamInfoBlock.md5Signature, SizeOf(TStreamInfoBlock.md5Signature));
...
function FLACReadSubframeConstant(frameHeader: PFrameHeader;
                              subframeHeader: PSubframeHeader;
                              bitReader: TBitReader;
                              sampleHandle: PSampleBuffer): DWord;
var
  sample: Integer;
  sampleIndex: Integer;
...
function FLACReadSubframeVerbatim(frameHeader: PFrameHeader;
                                  subframeHeader: PSubframeHeader;
                                  bitReader: TBitReader;
                                  sampleHandle: PSampleBuffer): DWord;
var
...
function FLACReadSubframeFixed(frameHeader: PFrameHeader;
                                subframeHeader: PSubframeHeader;
                                bitReader: TBitReader;
                                sampleHandle: PSampleBuffer): DWord;
var
...
function FLACReadSubframeLPC(frameHeader: PFrameHeader;
                              subframeHeader: PSubframeHeader;
                              bitReader: TBitReader;
                              sampleHandle: PSampleBuffer): DWord;
var
...
function FLACReadLPCResidual(frameHeader: PFrameHeader;
                              subframeHeader: PSubframeHeader;
                              bitReader: TBitReader;
                              sampleBuffer: TSampleBuffer;
                              sampleIndex: Integer;
...
begin
  ...
  begin
    ...
    Inc(sampleBuffer[sampleIndex], QWord(sample) shr qlpShift);
  end;
